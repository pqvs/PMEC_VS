...
#define SCALE_CAM (2470.0f/2550.0f) //  (Altura da camera - Altura do Robô) / Altura da Câmera 
#define LARGURA_LINHA ((LARGURA_CAMPO/2.0f) - (LARGURA_CAMPO/2.0f)*(2500.0f/2550.0f))// Largura do campo * (Altura da camera - Altura da Borda) / Altura da Câmera