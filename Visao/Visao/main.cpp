...
*/
		...
		//	
			...
			//cout<<((Robo*)objetos[0])->velocity_left<<endl;

			
			/*	i++;			
				if (i>150)i=50;
			*/	
				//((Robo*)objetos[0])->velocity_left = 75;
			//	//((Robo*)objetos[0])->velocity_right = 60; 
			
			
			//xcirc=25*cos(angcirc)+90;
			//ycirc=25*sin(angcirc)+65;
			// 
			objetos[3]->posicao.setX(xcirc);
			objetos[3]->posicao.setY(ycirc);
			
			  
			
			     cout<< objetos[3]->posicao.x << " - " << objetos[3]->posicao.y <<endl;	
				 cout<<"ok"<<endl;
